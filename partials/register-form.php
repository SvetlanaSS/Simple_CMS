        ...
        <form class="form-signin" action="admin/register.php" method="POST" name="registerform">
          <div class="form-group <?php if(isset($nameError) && $nameError !== '') { echo 'has-error'; } ?>">
           <label class="control-label" for="userName">Användarnamn *</label>
           <input type="login" class="form-control" name="userName" required>
           <span id="nameError" class="help-block"><?php if(isset($nameError) && $nameError !== '') { echo $nameError; } ?></span>
          </div>
          ...
          <div class="form-group <?php if(isset($emailError) && $emailError !== '') { echo 'has-error'; } ?>">
            ...
            <input type="text" class="form-control" name="userEmail"  required>
             <span id="emailError" class="help-block"><?php if(isset($emailError) && $emailError !== '') { echo $emailError; } ?></span>
          </div>
          <div class="form-group">
